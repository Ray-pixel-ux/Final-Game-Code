...
public partial class StoryScene : Control
{
	...
	[Export] private string nextScene = "res://scenes/HowToPlay.tscn";
	...
	public override void _Ready()
	{
		...
		// Skip label - positioned in upper right corner
		skipLabel = new Label
		{
			Text = "Skip",
			...
			OffsetLeft = -120, OffsetRight = -20,
			OffsetTop = 20, OffsetBottom = 60,
			HorizontalAlignment = HorizontalAlignment.Right,
			VerticalAlignment = VerticalAlignment.Center,
			Modulate = Colors.White
		};
		skipLabel.AddThemeFontSizeOverride("font_size", 24);
		skipLabel.AddThemeColorOverride("font_color", Colors.LightGray);
		AddChild(skipLabel);
		...
		tween.TweenProperty(skipLabel, "modulate", Colors.LightGray, 1f)
